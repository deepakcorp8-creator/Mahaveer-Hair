...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col relative overflow-hidden font-sans bg-[#060811] text-white selection:bg-[#B51A2B] selection:text-white">
                ...
                <div className="space-y-2 group/input">
                  ...
                  <div className="relative transition-transform duration-200 active:scale-[0.98]">
                    ...
                    <input
                      ...
                      className="w-full pl-14 pr-6 py-4 bg-[#060811]/60 border-2 border-slate-800 rounded-2xl text-sm font-bold text-white placeholder:text-slate-700 focus:outline-none focus:ring-4 focus:ring-[#B51A2B]/5 focus:border-[#B51A2B]/60 transition-all"
                ...
                <div className="space-y-2 group/input">
                  ...
                  <div className="relative transition-transform duration-200 active:scale-[0.98]">
                    ...
                    <input
                      ...
                      className="w-full pl-14 pr-16 py-4 bg-[#060811]/60 border-2 border-slate-800 rounded-2xl text-sm font-bold text-white placeholder:text-slate-700 focus:outline-none focus:ring-4 focus:ring-[#B51A2B]/5 focus:border-[#B51A2B]/60 transition-all"
                      placeholder="••••••••"
                      required
                    />
      ...
      {/* Unfixed Footer */}
      <div className="w-full py-4 flex flex-col md:flex-row items-center justify-center gap-6 z-50 pointer-events-none animate-slide-up-long relative mt-auto">

        <div className="pointer-events-auto relative group">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full blur opacity-30 group-hover:opacity-75 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
          <div className="relative flex items-center gap-3 px-6 py-3 bg-[#060811]/90 backdrop-blur-2xl rounded-full border border-white/10 shadow-2xl animate-float">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.3em] text-emerald-400/90 text-shadow-glow">Security Node Active</span>
          </div>
        </div>

        <div className="pointer-events-auto relative group cursor-default">
          <div className="absolute -inset-0.5 bg-gradient-to-r from-[#B51A2B] to-[#FFA586] rounded-full blur opacity-20 group-hover:opacity-60 transition duration-1000 group-hover:duration-200 animate-tilt"></div>
          <div className="relative flex items-center gap-4 px-6 py-3 bg-[#060811]/90 backdrop-blur-2xl rounded-full border border-white/10 shadow-2xl animate-float" style={{ animationDelay: '2s' }}>
            <div className="relative overflow-hidden">
              <div className="bg-gradient-to-br from-[#B51A2B] to-red-600 p-1.5 rounded-lg shadow-inner">
                <Code2 className="w-3.5 h-3.5 text-white" />
              </div>
            </div>
            <div className="flex flex-col">
              <span className="text-[8px] font-bold text-slate-500 uppercase tracking-wider mb-0.5">Engineered By</span>
              <a href="https://zentrix-dv.vercel.app/" target="_blank" rel="noopener noreferrer" className="block hover:opacity-80 transition-opacity">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 animate-shimmer bg-[length:200%_auto]">
                  Deepak Sahu
                </span>
              </a>
            </div>
