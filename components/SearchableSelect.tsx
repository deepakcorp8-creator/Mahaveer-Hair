...
export const SearchableSelect: React.FC<SearchableSelectProps> = ({
  ...
  return (
    <div className="relative" ref={wrapperRef}>
      ...
      {isOpen && (
        <div className="absolute z-50 w-full mt-2 bg-white rounded-xl shadow-xl border border-gray-200 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 animate-in fade-in zoom-in-95 duration-100" style={{ maxHeight: '400px' }}>
